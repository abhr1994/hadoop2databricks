...
try:
    ...
    os.system("dbfs cp /opt/infoworks/pepsico_history_migration/pep_delta_conversion.py dbfs:/FileStore/tables/pep_delta_conversion.py")
    job_name = args['file_type'] + " to Delta - Migration: "+ args["source_schema"]+ " : "+ args["table_name"]
    job_id = db.jobs.create_job(name=job_name, existing_cluster_id=args['cluster_id'], timeout_seconds=18000,
