...
try:
    ...
    os.system("dbfs rm dbfs:/FileStore/tables/delta_conversion.py")
    os.system("dbfs cp /home/infoworks/abhi/hadoop2databricks/delta_conversion.py dbfs:/FileStore/tables/delta_conversion.py")
